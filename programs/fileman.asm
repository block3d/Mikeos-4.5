...
start:
	...
	mov ax, .command_list			;.command Draw list of disk operations
	mov bx, .help_msg1
	mov cx, .help_msg2
	call os_list_dialog
	...
	cmp ax, 6
	je near .show_deleted_files

	cmp ax, 7
	je near .undelete_file
...
.draw_background:
	...
	.command_list		db 'Delete a file,Rename a file,Copy a file,Show file size,Show disk info,Show deleted files,Undelete File', 0
